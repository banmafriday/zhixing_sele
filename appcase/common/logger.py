...
if __name__ == "__main__":
    # log = Log()
    # log.info("---测试开始,用例001----")
    # log.debug("第一步：点输入框，输入内容：xxx")
    # log.warning("第二步：点输入框，输入内容：xxx")
    # log.error("---测试通过！---")
    print("[2018-06-30 21:18:38,633]-INFO---测试开始,用例001----")
    print("[2018-06-30 21:18:38,633]-INFO第一步：点输入框，输入内容：xxx")
    log = Log()
    log.info("---测试开始,用例001----")
    log.debug("第一步：点输入框，输入内容：xxx")
    log.debug("第二步：点输入框，输入内容：xxx")
    log.info("---测试通过！！！！！！----")
